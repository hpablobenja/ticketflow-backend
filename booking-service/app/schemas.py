...
class EventBase(BaseModel):
    title: str = Field(..., min_length=3, max_length=100, description="Título del evento masivo")
    date: datetime = Field(..., description="Fecha y hora del evento")
    total_tickets: int = Field(..., gt=0, description="Capacidad total de entradas del recinto")
